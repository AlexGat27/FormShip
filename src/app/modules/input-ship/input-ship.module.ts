...
import { DescriptionScreenSysshipComponent } from './shared-components/description-screen-sysship/description-screen-sysship.component';
...
@NgModule({
  declarations: [
    ...
    DescriptionScreenSysshipComponent,
  ],
  imports: [
    CommonModule,
    HttpClientModule,
